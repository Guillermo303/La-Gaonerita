  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <div className="text-center mb-16">
        <h1 className="heading-editorial text-4xl text-ink-900 mb-3">Sobre Nosotros</h1>
        <div className="w-16 h-1 bg-brand-500 mx-auto" />
      </div>

      <div className="grid md:grid-cols-2 gap-12 mb-16">
        <div className="drop bg-white border-2 border-ink-900 p-8">
          <div className="text-4xl mb-4">🎯</div>
          <h2 className="heading-editorial text-2xl text-brand-600 mb-4">Misión</h2>
        ...
        <div className="drop bg-white border-2 border-ink-900 p-8">
          <div className="text-4xl mb-4">🔭</div>
          <h2 className="heading-editorial text-2xl text-brand-600 mb-4">Visión</h2>
          <p className="text-ink-600 leading-relaxed">
      ...
      <div className="drop bg-brand-50 border-2 border-brand-500 p-8 text-center">
