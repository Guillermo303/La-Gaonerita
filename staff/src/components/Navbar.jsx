      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-5">
            {(user.role === 'admin' || user.role === 'mesero') && <Link to="/waiter" className="link-underline text-xs font-semibold uppercase tracking-widest text-cream-100/80 hover:text-white transition">Mesero</Link>}
