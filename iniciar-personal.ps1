# La Gaonerita - Lanzador (personal)
# Inicia backend, app de clientes y app de personal (si no estan corriendo) y abre la pagina de personal en el navegador.
...
# Esperar a que la app de personal responda (max 20 segundos)
for ($i = 0; $i -lt 40; $i++) {
    if (Test-Port 5174) { break }
