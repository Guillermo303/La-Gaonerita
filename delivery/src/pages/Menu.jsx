  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-14 pb-32">
      <div className="text-center mb-14">
        ...
        <h1 className="font-display text-4xl lg:text-5xl font-extrabold text-ink-900">Pide a Domicilio</h1>
        <div className="flex items-center justify-center gap-3 mt-4" aria-hidden="true">
          <span className="h-px w-12 bg-brand-400" />
          <span className="text-brand-500">✦</span>
          <span className="h-px w-12 bg-brand-400" />
        </div>
        <p className="text-ink-400 mt-4">Elige tus platillos y te los llevamos a tu puerta.</p>
      </div>
